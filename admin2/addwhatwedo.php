...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title mt-2">Edit What We Do</h4>
            ...
            <form id="editForm" class="com-mail" action="savewhatwedo.php" method="post" enctype="multipart/form-data">
                <!-- <label>Edit What We Do </label> -->
